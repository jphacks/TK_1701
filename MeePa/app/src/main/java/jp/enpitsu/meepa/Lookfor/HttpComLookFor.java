...
public class HttpComLookFor extends AsyncTask<Integer, Integer, String> {
    ...
    private jp.enpitsu.meepa.Lookfor.HttpComLookFor.AsyncTaskCallback callback = null;
    HttpComLookFor(jp.enpitsu.meepa.Lookfor.HttpComLookFor.AsyncTaskCallback callback) {
